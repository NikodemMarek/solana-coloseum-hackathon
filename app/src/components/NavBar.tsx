...
export default function NavBar() {
    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            ...
            ></div>
            <div
                className={`fixed z-30 h-screen w-64 left-0 top-0 rounded-r bg-purple-200 ease-in-out duration-150 ${
                    showSidebar ? "translate-x-0 " : "translate-x-[-16rem]"
                }`}
            >
                <button type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 end-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" onClick={() => {
