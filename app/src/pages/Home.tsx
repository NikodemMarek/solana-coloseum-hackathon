                ...
                <div className="w-full lg:w-[1024px]">
                    ...
                    <div className="hidden sm:flex items-center w-full justify-between mt-16">
                        <div className="ml-2 text-[4rem] leading-none border-2 p-5 rounded-3xl bg-[#6C63FF]/20 border-[#6C63FF]/10">
                            <div className="mb-1 w-80" id="question">
                                Looking for</div>
                            <div className="flex items-center">
                                <div id="idea1" className="ml-10 my-auto h-[5rem] overflow-hidden text-end">
                                    <div className="h-[5rem] text-violet-800">an awesome</div>
                                    <div className="h-[5rem] text-purple-700">a project</div>
                                    <div className="h-[5rem] text-fuchsia-800">a business</div>
                                    <div className="h-[5rem] text-violet-800">an awesome</div>
                                </div>
                                <div className="h-[5rem] my-auto">&nbsp;idea?</div>
                            </div>
                        </div>
                        <Button
                    ...
                    <div className="hidden sm:flex items-center w-full justify-between mt-24">
                        <Button
                            ...
                            onClick={() => navigation("/newIdea")}
                        >Share</Button>
                        <div className="mx-2 text-[4rem] leading-none text-end border-2 p-5 rounded-3xl bg-[#6C63FF]/90 border-[#6C63FF] text-white">
                            <div className="mb-1 w-[40rem] mr-20">Want to share your</div>
                            <div className="flex items-center justify-end">
                                <div id="idea2" className="my-auto h-[5rem] overflow-hidden text-right">
                                    <div className="h-[5rem] text-violet-200">great new</div>
                                    <div className="h-[5rem] text-fuchsia-200">life changing</div>
                                    <div className="h-[5rem] text-purple-300">project</div>
                                    <div className="h-[5rem] text-violet-200">great new</div>
                                </div>
                                <div className="h-[5rem] my-auto text-left">&nbsp;idea?</div>
                            </div>
                        </div>
                    </div>
                </div>
